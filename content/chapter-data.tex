...
%\centerline{PAD\detokenize{_}token  \mapsto 0 \textit{  Dùng để chêm vào các câu ngắn}}
...
%count(adscititious) < 3  \to \varnothing \\
2) Lọc các cặp đối thoại có từ đã được xóa bỏ trong vocabulary \\
%[this sentence have adscititious, really] \to \varnothing \\